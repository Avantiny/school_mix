...
L = el2_c02_field([0 6 0 4], 0.01, [3 1], [2 4], 0.1, 1000, 0.01);
...
PhiTotal = zeros(length(y),length(x));
...
% 3) vypocet vzdalenosti r a uhlu phi mezi aktualnim bodem a pozici zdroje
       [phi, r] = cart2pol(x(n)-sourcex(q),y(m)-sourcey(q));
